...
/* Primitive cwmp:SupportedCWMPVersions schema type: */
...
/* Primitive cwmp:UseCWMPVersion schema type: */
...
{
    struct _cwmp__ID * ID;
    struct _cwmp__HoldRequests * HoldRequests;
    struct _cwmp__SessionTimeout * SessionTimeout;
    struct _cwmp__SupportedCWMPVersions * SupportedCWMPVersions;
    struct _cwmp__UseCWMPVersion * UseCWMPVersion;
};
#endif
